...
echo "Aplicando reglas de iptables para bloquear sitios..."
...
# Verifica si el servicio iptables está instalado
...
# Habilita y reinicia el servicio para que cargue reglas al arrancar
systemctl enable iptables
systemctl restart iptables

echo "Reglas aplicadas y guardadas correctamente para que persistan tras reinicio."
